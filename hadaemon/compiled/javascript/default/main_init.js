$(function(){ //DOM Ready
    ...
    // Initialize Widgets
        ...
        widgets["default-light-office-gateway-light"] = new baselight("default-light-office-gateway-light", "", "default", {'widget_type': 'baselight', 'title_is_friendly_name': 1, 'post_service_active': {'entity_id': 'light.office_gateway_light', 'service': 'homeassistant/turn_on'}, 'post_service_inactive': {'entity_id': 'light.office_gateway_light', 'service': 'homeassistant/turn_off'}, 'use_comma': 0, 'static_css': {'state_text_style': 'color: #fff;', 'widget_style': 'background-color: #444;', 'level_style': 'color: #fff;', 'title_style': 'color: #fff;', 'level_up_style': 'color: #888;', 'unit_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'level_down_style': 'color: #888;'}, 'icons': {'icon_on': 'fa-circle', 'icon_off': 'fa-circle-thin'}, 'precision': 1, 'namespace': 'default', 'entity': 'light.office_gateway_light', 'static_icons': {'icon_up': 'fa-plus', 'icon_down': 'fa-minus'}, 'fields': {'state_text': '', 'level': '', 'title2': '', 'title': '', 'units': '%', 'icon': '', 'icon_style': ''}, 'use_hass_icon': 1, 'css': {'icon_style_active': 'color: #aaff00;', 'icon_style_inactive': 'color: #888;'}})
